...
const payload:any={source:"test",crossSeries:{TQQQ:series(10,.00055),QLD:series(20,.00040),QQQ:series(100,.00025),UPRO:series(30,.00048),SSO:series(40,.00035),SPY:series(100,.00020),VIX:dates.map(d=>bar(d,18))}};
